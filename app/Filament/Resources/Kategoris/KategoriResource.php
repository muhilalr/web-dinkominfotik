...
class KategoriResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Kategori Posts';

    protected static ?string $modelLabel = 'Kategori Posts';

    protected static ?string $pluralModelLabel = 'Kategori Posts';
