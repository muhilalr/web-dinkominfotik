<x-app-layout>
          ...
          <div class="flex items-center">
            ...
            <nav x-show="mobileOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" @click.outside="mobileOpen = false" class="absolute py-3 bg-utama shadow-lg w-full right-0 top-full lg:hidden overflow-auto max-h-[80vh]">
              <ul class="flex flex-col w-full text-white">
                ...
                <li>
                  <button @click="dd.profil = !dd.profil" class="w-full py-2.5 px-5 text-[13px] font-medium flex items-center justify-between hover:bg-white/10 transition-colors">
                ...
                <li>
                  <button @click="dd.berita = !dd.berita" class="w-full py-2.5 px-5 text-[13px] font-medium flex items-center justify-between hover:bg-white/10 transition-colors">
                ...
                <li>
                  <button @click="dd.layanan = !dd.layanan" class="w-full py-2.5 px-5 text-[13px] font-medium flex items-center justify-between hover:bg-white/10 transition-colors">
                ...
                <li>
                  <button @click="dd.ppid = !dd.ppid" class="w-full py-2.5 px-5 text-[13px] font-medium flex items-center justify-between hover:bg-white/10 transition-colors">
            ...
            <nav class="hidden lg:block">
              <ul class="flex items-center gap-1">
                ...
                <li class="relative" @mouseenter="dd.profil = true" @mouseleave="dd.profil = false">
                  <button class="text-white text-[11px] font-medium px-3 xl:px-3.5 py-2 flex items-center gap-1.5 hover:bg-white/10 rounded-lg transition-colors">
    ...
    <footer class="container bg-utama mt-16 px-10 pt-6 pb-10 flex flex-col md:flex-row md:justify-between md:pb-6 md:items-center">
      <a href="{{ url('/') }}">
        <img src="{{ asset('img/logo-dinkominfotik.png') }}" alt="" width="250" />
      </a>
      ...
      <div class="flex flex-col mt-6 md:mt-0 md:border-l-2 md:border-slate-500 md:pl-3">
        ...
        <p class="font-normal text-sm text-slate-300">Email : dinkominfotik@bangka.go.id</p>
      </div>
    </footer>
